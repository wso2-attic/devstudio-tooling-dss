...
public class DsPackageImpl extends EPackageImpl implements DsPackage {
	 ...
	 * @generated
	 */
	public EAttribute getConfigurationProperty_SecretAlias() {
	 ...
	 * @generated
	 */
	public EAttribute getDataService_DisableLegacyBoxcarringMode() {
		return (EAttribute)dataServiceEClass.getEStructuralFeatures().get(20);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(configurationPropertyEClass, CONFIGURATION_PROPERTY__SECRET_ALIAS);
		...
		createEAttribute(dataServiceEClass, DATA_SERVICE__DISABLE_LEGACY_BOXCARRING_MODE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConfigurationProperty_SecretAlias(), ecorePackage.getEString(), "secretAlias", null, 0, 1, ConfigurationProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDataService_DisableLegacyBoxcarringMode(), theXMLTypePackage.getBoolean(), "disableLegacyBoxcarringMode", null, 0, 1, DataService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQuery_ReturnUpdatedRowCount(), theXMLTypePackage.getBoolean(), "returnUpdatedRowCount", "false", 0, 1, Query.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
